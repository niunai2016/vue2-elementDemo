<template>
    <div class="shopcart">
        <div class="cont" @click="toggleList">
            <div class="cont-left">
        ...
        <div class="ball-container">
            <transition-group name="drop" v-on:before-enter="beforeEnter" v-on:enter="enter" v-on:after-enter="afterEnter">
                ...
                <div class="ball" v-for="(ball,ind) in balls" v-show="ball.show" key="ind">
